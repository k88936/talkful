...
import authDialogService from '@jetbrains/ring-ui-built/components/auth-dialog-service/auth-dialog-service';
import Link from '@jetbrains/ring-ui-built/components/link/link';
import Auth from '@jetbrains/ring-ui-built/components/auth/auth';
import IFrameFlow from '@jetbrains/ring-ui-built/components/auth/iframe-flow';
