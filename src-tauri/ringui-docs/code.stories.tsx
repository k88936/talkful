...
import Code, {code, highlight} from '@jetbrains/ring-ui-built/components/code/code';
...
export const basic = () => (
  <Code
    code={`
          ...
          import ChildComponent from '@jetbrains/ring-ui-built/components/code/child-component';
