...
import highlightStyles from '@jetbrains/ring-ui-built/components/code/highlight.css';
...
import ChildComponent from '@jetbrains/ring-ui-built/components/markdown/child-component';
