...
import showAuthDialog from '@jetbrains/ring-ui-built/components/auth-dialog-service/auth-dialog-service';
...
import {type ClickableLinkProps} from '@jetbrains/ring-ui-built/components/link/clickable-link';
import Header, {type HeaderAttrs, Profile} from '@jetbrains/ring-ui-built/components/header/header';
...
import HeaderIcon from '@jetbrains/ring-ui-built/components/header/header-icon';
import SmartServices from '@jetbrains/ring-ui-built/components/header/smart-services';
import SmartProfile from '@jetbrains/ring-ui-built/components/header/smart-profile';
