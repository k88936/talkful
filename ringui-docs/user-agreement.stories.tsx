...
import UserAgreement, {type UserAgreementAttrs} from '@jetbrains/ring-ui-built/components/user-agreement/user-agreement';
import UserAgreementService, {type Agreement, type Consent, type ConsentResponse} from '@jetbrains/ring-ui-built/components/user-agreement/service';
import text from '@jetbrains/ring-ui-built/components/user-agreement/toolbox.eula';
