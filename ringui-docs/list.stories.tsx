...
import ContentLayout, {Sidebar} from '@jetbrains/ring-ui-built/components/content-layout/content-layout';
import Link from '@jetbrains/ring-ui-built/components/link/link';
import List, {type ListAttrs} from '@jetbrains/ring-ui-built/components/list/list';
...
import styles from '@jetbrains/ring-ui-built/components/list/list.stories.css';
