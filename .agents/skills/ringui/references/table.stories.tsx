...
import Table, {Table as BaseTable, type TableAttrs} from '@jetbrains/ring-ui-built/components/table/table';
import MultiTable from '@jetbrains/ring-ui-built/components/table/multitable';
import Selection from '@jetbrains/ring-ui-built/components/table/selection';
import {type SortParams} from '@jetbrains/ring-ui-built/components/table/header-cell';

import mock from '@jetbrains/ring-ui-built/components/table/table.stories.json';
import tableData from '@jetbrains/ring-ui-built/components/table/table.examples2.json';
