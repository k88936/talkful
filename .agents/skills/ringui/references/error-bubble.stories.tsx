...
import Select, {type SingleSelectAttrs} from '@jetbrains/ring-ui-built/components/select/select';
...
import ErrorBubble from '@jetbrains/ring-ui-built/components/error-bubble/error-bubble';
