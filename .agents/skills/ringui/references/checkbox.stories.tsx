...
import ControlLabel, {LabelType} from '@jetbrains/ring-ui-built/components/control-label/control-label';
import Checkbox, {type CheckboxProps} from '@jetbrains/ring-ui-built/components/checkbox/checkbox';
