...
import DatePicker, {type DatePickerAttrs} from '@jetbrains/ring-ui-built/components/date-picker/date-picker';
import {type DatePickerChange} from '@jetbrains/ring-ui-built/components/date-picker/consts';
